...
our $SCHEMA = [
    ...
    {cat => ['game',        'Juego',       'applications-games']},
    {cat => ['graphics',    'Gráficos',    'applications-graphics']},
    {cat => ['audiovideo',  'Multimedia',  'applications-multimedia']},
    {cat => ['network',     'Redes',     'applications-internet']},
    ...
    {sep => 'Configuraciones'},
    {cat => ['settings',    'Configuraciones',    'applications-accessories']},
    {beg => ['Configuraciones Avanzadas', 'applications-engineering']},
